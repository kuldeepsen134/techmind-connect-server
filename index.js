...
const corsOptions = {
  origin: ['https://techmindconnect.netlify.app/', 'http://localhost:3000', 'https://localhost', 'chrome-extension://pmloiaangebidmdofglcfolcagjhaaob'], // Specify the allowed origin(s)
